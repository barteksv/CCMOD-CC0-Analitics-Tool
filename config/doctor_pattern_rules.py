...
CATEGORY_KEYWORDS = {
    ...
    "Tooth movement / alignment": [r"\balign(?:ment)?\b", r"\bmovements?\b", "mouvement", "movimiento", "round trip", "overcorrection"],
    "Staging / sequencing": ["stage", "staging", "sequence", "sequential", "one by one", "not en masse", "as late as possible", "after alignment", "after alignement", r"\bafter\s+(?:proclination|procline|intrusion|intrude|retraction|retract|distalization|distalisation|mesialization|mesialisation|expansion)\b", r"\bduring\s+(?:distalization|distalisation|mesialization|mesialisation|proclination|procline|intrusion|intrude|retraction|retract|deep\s+bite\s+correction)\b", r"\b(?:procline|intrude|retract|distalize|distalise|mesialize|mesialise|expand)\s+first\b", "postpone", "postpond", "etape", "etapa"],
    ...
    "Elastics / cutouts / buttons / hooks": ["cutout", "cut out", "cuts", "button", "hook", "elastic", "precision cut", "power ridge"],
    "Bite ramps": ["bite ramp", "bite ramps", "biteramp", "biteramps", "bite plane"],
    "Occlusion / bite / contacts": ["occlusion", "occlusal", "contacts", "inter-arch", "interarch", "heavy occlusal", "occlusal contacts", "bite contact", "bite contacts", "open bite", "crossbite", "oclusion"],
    ...
    "Rotation / torque / intrusion / extrusion": ["rotation", "torque", "intrusion", "extrusion", "rotate", "intrude", "extrude", "procline", "proclination", "retract", "retraction", "retact", "crowntip", "crown tip", "buccal crowntip", "buccal crown tip"],
