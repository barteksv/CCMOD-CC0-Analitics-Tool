...
CATEGORY_KEYWORDS = {
    ...
    "Staging / sequencing": ["stage", "staging", "sequence", "sequential", "one by one", "not en masse", "as late as possible", "after alignment", "after alignement", "postpone", "postpond", "etape", "etapa"],
    ...
    "Occlusion / bite / contacts": ["occlusion", "occlusal", "contacts", "inter-arch", "interarch", "heavy occlusal", "occlusal contacts", "bite contact", "bite contacts", "open bite", "deep bite", "crossbite", "oclusion"],
